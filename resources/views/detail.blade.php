			...
			<div class="collapse navbar-collapse" id="navbarsExampleDefault">
				...
				<ul class="navbar-nav ml-auto">
					<li class="nav-item active">
						<a class="nav-link" href="#p"><b>Event</b> <span class="sr-only">(current)</span></a>
					</li>
					...
					<div class="card-block">
						...
						<div class="metafooter">
							<div class="wrapfooter">
								...
								<span class="post-date">Tanggal event : {{ $b->tanggal_event }}</span><span class="dot"></span><span class="post-read"></span>
								</span>
								<span class="post-read-more"><a  title="Read More"></a></span>
							</div>
						</div>
					</div>
				</div>
