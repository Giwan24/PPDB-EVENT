    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="/admin/tambah" class="nav-link active">
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Masukan Nama Event ..." name="nama_event" required="required"><br/>
                      </div>
                    </div>
                  </td></tr>
                  <tr><td>
                  <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" placeholder="Masukan Deskripsi Singkat ..." name="deskripsi_singkat" required="required"></textarea>
                      </div>
                    </div>
                    </td></tr>
                    <tr><td>
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="ckeditor" id="ckedtor" name="deskripsi" required="required"></textarea>
                      </div>
                    </div>
                </div>
                </td></tr>
                <tr><td>
                  <div class="row">
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        <label>Gambar</label>
                        <input type="text" class="form-control" placeholder="Masukan Link Gambar ..." name="gambar" required="required"><br/>
                      </div>
                    </div>
                    </td></tr>
                    <tr><td>
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <input type="date" class="form-control" placeholder="Masukan Tanggal Event ..." name="tanggal_event" required="required"><br/>
                      </div>
                    </div>
                    </td></tr>   
                    <tr><td>              
